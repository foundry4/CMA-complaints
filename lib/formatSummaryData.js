...
console.log(data['report_reason'], data['report_reason'].indexOf('pricing'),data['product'],data['other_product'])
        ...
        let show_products;
        if(data) {
            show_products = data['report_reason'].indexOf('pricing') >-1
        }
        console.log('after summary = ',business, reason, product_list, contacts, total_errors, errors, error_end, error_start);
