...
module.exports = (data)=>{
  try {
    ...
    const other_product = parse_attribute(data,'other_product');
    const other_location = parse_attribute(data, 'other_location');
    const is_online = data['is-online']==='true';
    const evidence_url = parse_attribute(data, 'evidence_url');
